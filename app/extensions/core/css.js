JMVC.extend('css.pointer', function () {
    ...
    var instance = false,
        ...
        create = function () {
            ...
            JMVC.css.style(square, {'pointer-events': 'none', position:'absolute', zIndex:2000, width:squareSize + 'px', height:squareSize + 'px', border: '1px solid #444',backgroundColor: 'coral', opacity:.5});
