...
JMVC.extend('console', {
	'init' : function () {
		...
		JMVC.dom.append(edit, edit_html);
		JMVC.dom.append(edit, edit_js);
		JMVC.dom.append(edit, edit_css);
		JMVC.dom.add(edit, 'br', {style:'clear:both;display:none;'});
