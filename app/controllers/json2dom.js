    ...
    this.action_index = function (){
        ...
        function another () {
            ...
            JMVC.core.json2dom.render({
                ...
                content : [{
                    ...
                    cb : function () { console.debug('inner 1'); this.done();}
                }]
            }, footer);
        ...
        function toggleText (){
            ...
            JMVC.events.one(this, 'click', function () {
                drawText = !drawText;
                JMVC.core.json2dom.render(getConfig(), JMVC.dom.find('#extralogo'));
            });
