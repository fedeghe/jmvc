JMVC.controllers.checkns = function() {
	this.action_index = function(){
		...
		this.render(function test(){
			...
			JMVC.test.testValue("JMVC.nsCheck('extensions.dom.find', ns)();", function(){return JMVC.nsCheck('extensions.dom.find', ns)();}, 'ns.extensions.dom.find');
			JMVC.test.testValue("JMVC.nsCheck('vars.name', ns);", function(){return JMVC.nsCheck('vars.name', ns);}, 'jmvc');
			JMVC.test.testValue("JMVC.nsCheck('vars.data.calendars', ns).toString();", function(){return JMVC.nsCheck('vars.data.calendars', ns).toString();}, '1,2,3');
