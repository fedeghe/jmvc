JMVC.require('core/obj/date/date');
...
JMVC.controllers.date = function () {
    ...
    this.action_index = function (sunday) {
        ...
        this.render(false, function test () {
            ...
            JMVC.test.testValue('1 Jan ' + y + ' is in the week ' + (isSunday ? 1 : 52), function () { return JMVC.date.day2week(new Date(y, 0, 1)); }, isSunday ? 1 : 52);
            ...
            JMVC.test.message('sun');
            JMVC.test.testValue('8 Jan ' + y + ' is in the week ' + (isSunday ? 2 : 1), function () { return JMVC.date.day2week(new Date(y, 0, 8)); }, isSunday ? 2 : 1);
            ...
            JMVC.test.message('sun');
            JMVC.test.testValue('30 Dec ' + y + ' is in the week ' + (isSunday ? 1 : 52), function () { return JMVC.date.day2week(new Date(y, 11, 30)); }, isSunday ? 1 : 52);
            ...
            hmanyinyear = JMVC.date.weekInYear(y + more);
