...
JMVC.extend('core.color', {
    ...
    rgb2hex: function (obj) {
        ...
        if (typeof obj === 'object') {
            ...
            arrRgb = obj.split(',');
            r = parseInt(arrRgb[0], 10);
            g = parseInt(arrRgb[1], 10);
            b = parseInt(arrRgb[2], 10);
            a = arrRgb.length === 4 ? parseInt(arrRgb[3], 10) : 255;
        }
    ...
    test2col: function (rgb1, rgb2) {
        var m = Math,
            brigthDiff = m.abs((rgb1.r * 299 + rgb1.g * 587 + rgb1.b * 114) - (rgb2.r * 299 + rgb2.g * 587 + rgb2.b * 114)) / 1000,
            colorDiff = (m.max(rgb1.r, rgb2.r) - m.min(rgb1.r, rgb2.r)) + (m.max(rgb1.g, rgb2.g) - m.min(rgb1.g, rgb2.g)) + (m.max(rgb1.b, rgb2.b) - m.min(rgb1.b, rgb2.b));
        return brigthDiff > 125 && colorDiff > 500;
    },
