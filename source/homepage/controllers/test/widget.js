        ...
        v.render({
            cback: function () {
                ...
                var container = JMVC.dom.find('#content'),
                    ...
                    // slider
                    slider1 = new JMVC.widget.Slider(JMVC.dom.add(container, 'div', { id: 'slider1', style: 'margin-top:10px' }), 300),
                    ...
                    btn1 = JMVC.dom.create('input', { type: 'button', value: 'm1' }),
                    btn2 = JMVC.dom.create('input', { type: 'button', value: 'm2' }),
                    btn3 = JMVC.dom.create('input', { type: 'button', value: 'm3' }),

                    inputxt = JMVC.dom.create('input', { type: 'text', 'id': 'dbgtxt' }),
                    contAcc = JMVC.dom.add(container, 'div', { 'id': 'waccord', 'style': 'width:200px;margin-top:20px' }),
                    acc = new JMVC.widget.Accordion(150, true, 'black');
