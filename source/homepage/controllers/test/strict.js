    ...
    this.action_index = function () {
        this.render(false, function () {
            ...
            var assignToNonWritable = function () {
                ...
                assignWhenSetterUndefined = function () {
                    'use strict';
                    var obj = {};
                    // eslint-disable-next-line accessor-pairs
                    Object.defineProperty(obj, 'name', { set: undefined });
                    obj.name = 'cuttlefish';
                },
                assignToNonExtensible = function () {
                    'use strict';
                    var obj = {};
            ...
            JMVC.test.testException(
                ...
                function () { 'use strict'; console.log(arguments.callee); },
                TypeError
            );
            ...
            assignToFormalParams = function (x) {
                'use strict';
                x = 3;
                return arguments[0];
            };
            ...
            JMVC.test.testException(
                ...
                /* eslint-disable */
                function () { 'use strict'; eval('var a = 99'); console.log(a); },
                /* eslint-enable */
                ReferenceError
            );
            ...
            deleteNonConfigurable = function () {
                'use strict';
                var obj = {};
                Object.defineProperty(obj, 'name', {
                    configurable: false
            ...
            functionConstructorStr = "new Function('eval', 'use strict')";
