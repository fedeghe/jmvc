    ...
    toggle: function (h, j, c, tab) {
        function start () {
            ...
            function update () {
                ...
                function innerload () {
                    appendScript('/app/' + jmvcIframeFile, iframe.contentWindow, function () {
                ...
                try {
                    ...
                    (lib && appendScript(lib, iframe.contentWindow, innerload)) || innerload();
                } catch (e) {
                    console.error(e);
                }
            }
        ...
        var fsmode = false,
            ...
            container = JMVC.dom.create(
                'div', {
                    'id': 'jmvc-console',
                    'class': 'jmvc-console',
                    'style': 'left:' + margin + 'px;right:' + margin + 'px;top:' + margin + 'px;bottom:' + margin + 'px;border:' + borderSize + 'px solid black'
                }
            ),
            content = {
                h: typeof h !== 'undefined' ? h : (JMVC.p.h ? decodeURIComponent(JMVC.p.h) : defaultContent.h),
                j: typeof j !== 'undefined' ? j : (JMVC.p.j ? decodeURIComponent(JMVC.p.j) : defaultContent.j),
                c: typeof c !== 'undefined' ? c : (JMVC.p.c ? decodeURIComponent(JMVC.p.c) : defaultContent.c)
            },
            version = 0.4,
            defaults = {
                h: '<!-- no html content -->',
