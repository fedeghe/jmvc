...
JMVC.extend('array', {
     ...
     * @return {[type]}       [description]
     */
    bNearestElement: function calle (v, steps) {
        ...
        return calle(v, steps.slice(r1, r2));
    },
    ...
    origNearest: function (value, sortedValues) {
        ...
        if (sortedValues.length > 0) {
            ...
            closestIndex = middleIndex > 0 &&
                middleIndex < sortedValues.length - 1
                ? middleIndex - 1 + findMinDistanceIndex1(sortedValues[middleIndex - 1], value, sortedValues[middleIndex], sortedValues[middleIndex + 1])
                : middleIndex === 0
                    ? findMinDistanceIndex(sortedValues[middleIndex], value, sortedValues[middleIndex + 1])
